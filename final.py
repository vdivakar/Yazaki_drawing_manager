...
def decrypt_path(file_path):
	file_path = file_path[6:]
	dec_path = ""
	for c in file_path:
		dec_path += chr(ord(c)+10)
	# print dec_path
	return dec_path
...
def connect():
	...
	try:
		...
		path_app_data = decrypt_path(path_app_data)
...
class Admin_Page(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		self.gray_frame= tk.Frame(self, bg = "gray", width = 880, height = 15)
		...
		self.partButton.grid(column = 0, row = 1, padx = 5, pady = 5, rowspan = 2,ipadx = 15, ipady = 3)
		...
		self.viewer_page.grid(column = 4, row = 1, padx = 5, pady = 5, rowspan = 2,ipadx = 20, ipady = 3)
		...
		self.csv_log.grid(column = 5, row = 1, padx = 5, pady = 5, rowspan = 2,ipadx = 35, ipady = 3)
		...
		self.csv_online.grid(column = 6, row = 1, padx = 5, pady = 5, rowspan = 2,ipadx = 15, ipady = 3)
...
class PartMaster(tk.Frame):
	...
	# to display text on the tk canvas
	...
	def scroll(self, files, controller):
		...
		self.canvas = tk.Canvas(self.online_Frame, borderwidth=0, width = 320, height = 412)
		...
		self.searchBox = tk.Entry(self.online_Frame, width = 50, border = 2, textvariable = self.to_search, relief = "groove", bg = "white")
	...
	def __init__(self, parent, controller):
		...
		self.fname_canvas = tk.Canvas(self.entry_frame, bg = "white", height = 22, width = 450)
		...
		self.online_Frame = tk.LabelFrame(self, border = 2, text = "Browse Online",  width = 360, height = 485)
...
class UserMaster(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		self.gray_frame= tk.Frame(self, bg = "gray", width = 880, pady = 0, padx = 0, height = 15)
...
def scroll(self, files):
	...
	self.canvas = tk.Canvas(self.online_Frame, borderwidth=0, background="#ffffff", width = 350, height = 375)
	...
	self.canvas.xview_moveto(0)
	self.hsb = tk.Scrollbar(self.online_Frame,width = 350, orient="horizontal", command=self.canvas.xview)
	self.canvas.configure(xscrollcommand=self.hsb.set)
	...
	self.searchBox = tk.Entry(self.online_Frame, width = 50, border = 2, textvariable = to_search, relief = "groove", bg = "white")
...
def call_view_gui(self, controller):
		...
		self.online_Frame = tk.LabelFrame(self, border = 2, text = "Browse Online",  width = 250, height = 485)
